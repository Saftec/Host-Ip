...
>>>>>>> branch 'master' of https://github.com/lazaro94/Host-Ip
		...
		btnActualizar.setEnabled(false); //BLOQUEO EL BOT�N HASTA QUE SE CARGUEN LOS DATOS.
		...
		btnEditarBD.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (res==true) {JOptionPane.showMessageDialog(null, "Cambios guardados. Se reiniciará la herramienta"); 
				frame.dispose();				
				Ventana.main(null);}
